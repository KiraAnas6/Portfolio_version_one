    ...
    <section className="bg-black-100">
      ...
      <div className="relative z-1 inset-0 h-screen">
        ...
        <div className="absolute inset-1/2 text-center -translate-x-1/2 -translate-y-1/2  w-fit h-fit  ">
          <h3 id="hero-title" className="opacity-0 -translate-y-20 text-main uppercase tracking-tighter font-semibold text-xs mb-2">
            Welcome to Anas World's
          </h3>
          <div className="text-[12vw] font-bold leading-none">
            <h1 id="hero-title" className="opacity-0 -translate-y-20 ">VISION</h1>
            <h1 id="hero-title" className="opacity-0 translate-y-20 italic hero-text-outline">UNBOUND</h1>
          </div>
          <p id="hero-title" className="opacity-0 translate-y-20 text-gray italic text-[12px]">
